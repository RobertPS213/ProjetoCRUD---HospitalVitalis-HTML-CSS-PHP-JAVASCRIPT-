...
<html>
    <head>
        ...
        <title>Cadastro de Recepcionista - Hospital Vitalis</title>
    ...
    <body>
        <div class="content">
            ...
            <div class="form-container">
                <form action="../../Controle/ControleUsuarios.php?ACAO=cadastrarRecepcionista" method="POST">
                    <div class="mb-3">
                    ...
                    <button type="submit" class="btn btn-danger w-100" id="botao">Cadastrar Recepcionista</button>
                </form>
            </div>
        </div>
        <?php
